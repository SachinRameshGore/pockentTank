...
public interface button_specifications{
	...
	public static int start_new_x = 300+160-190;
	public static int start_new_y = 60;
	...
	public int fieldX = 245,fieldY = 90;
	public int fieldWidth = 290,fieldHeight = 30;
	
	
	public static String one = "Angle:";
	public static String two = "Power:";
	public static String three = "Weapons:";
	public static String four = "Fire:";
