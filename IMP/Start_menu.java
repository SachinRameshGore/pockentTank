...
public class Start_menu{
	...
	public Start_menu()
	{
		...
		bf2 = ImageIO.read(new File("saved_image.jpg"));//saved_image.jpg"));
	...
	public void render(Graphics G)
	{
		...
		try{
			...
			Font f = Font.createFont(Font.TRUETYPE_FONT, new FileInputStream(new File("prototype.ttf"))).deriveFont(Font.PLAIN,30);
			g.setFont(f);
		}catch(Exception E){}
