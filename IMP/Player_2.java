...
public class Player_2{
		...
		public void move_the_terrain(terrain t){
			...
			if(hand.get_turn() == TURN.LOADING )//&& br == true && b2 == false)
			{
				...
				{
					x1 =  (int)((s.getX()-(s.get_damage_radius()))/bt.Pixel_size);
					x2 =  (int)((s.getX()+(s.get_damage_radius()))/bt.Pixel_size);
					y1 =  (int)((s.getY()-(s.get_damage_radius()))/bt.Pixel_size);
					y2 =  (int)((s.getY()+(s.get_damage_radius()))/bt.Pixel_size);
